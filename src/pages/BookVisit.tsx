                ...
                <div className="px-5 pb-5 space-y-3.5">
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', width: '100%' }}>
                    <div className="min-w-0 overflow-hidden">
                      ...
                      <div className="relative mt-1.5">
                        <CalendarDays className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-stone-300 pointer-events-none z-10" />
                        <Input id="interestDate" type="date" value={interestDate} onChange={e => setInterestDate(e.target.value)} className="pl-10 h-11 rounded-xl bg-stone-50/50 border-stone-200 focus:bg-white text-sm w-full box-border" />
                      </div>
                    </div>
                    <div className="min-w-0 overflow-hidden">
                      <Label htmlFor="guests" className="text-xs font-semibold text-stone-600">Nº de pessoas</Label>
                      <div className="relative mt-1.5">
                        <Users className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-stone-300 pointer-events-none z-10" />
                        <Input id="guests" type="number" min="1" value={guestCount} onChange={e => setGuestCount(e.target.value)} placeholder="Ex: 100" className="pl-10 h-11 rounded-xl bg-stone-50/50 border-stone-200 focus:bg-white w-full box-border" />
                      </div>
                    </div>
                  </div>
